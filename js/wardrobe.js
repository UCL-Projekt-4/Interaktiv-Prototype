...
/* TODO Liste
  Done: Lav eksempel med et stykke tøj, i forhold til hvor hjertet skal side. 
  Done: Lav hjertet funktionelt, at når man trykker på det så ændre det farve
  Done: Når man har trykket på hjertet på bliver det tilføjet til en liste i klædeskabet
  TODO: Lav klædeskabet til at vise listen af likede ting
  TODO: Lav at man kan fjerne ting fra klædeskabet igen
*/
...
// Funktion til at oprette et clothing item element
function createClothingItem(product) {
...
document.addEventListener("DOMContentLoaded", function () {
  // Hent tidligere likede produkter
  loadLikedProducts();

  // Opret clothing items fra data
  products.forEach((product) => {
    createClothingItem(product);
  });
});
